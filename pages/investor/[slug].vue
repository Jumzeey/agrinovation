          ...
          <div class="flex gap-6 lg:flex-row flex-col">
            ...
            <div>
              ...
              <div class="flex gap-5 w-[300px] lg:w-full mb-[29px]">
                <div class="border border-[#CCCCCC] w-full rounded-lg p-1">
    ...
    >
      ...
      >
        ...
        <div class="hidden lg:flex">
          <NuxtLink
            class="border border-[#D0D5DD] rounded-md p-2 text-sm"
            to="/"
            >View All</NuxtLink
          >
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-7 mb-7">
          <div class="w-full sm:w-1/2 lg:w-auto">
            <div class="mx-auto">
              ...
              <p class="text-[#76BD21] text-lg font-normal">
                Farm Coordinators
              </p>
            </div>
          </div>
      ...
      <div class="">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-7">
          <div class="w-[full] rounded-2xl shadow py-[23px] px-4">
            <img
              src="../../public/images/agripreneur/image.svg"
              class="rounded-2xl pb-2"
              alt=""
            />

            <h3 class="text-[#261B0D] text-xl pb-2">Farm Manager</h3>
            <p class="text-[#261B0D] text-sm pb-2">
              Farm Manager VGA Limited Lagos Nigeria
            </p>
    ...
    >
      <div class="flex flex-col items-center py-[96px]">
        ...
        <p class="text-[#667085] text-xl font-normal">
          Reach out to us through our social media platform
        </p>

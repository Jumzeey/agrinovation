    ...
    <div class="px-10 md:px-[120px] flex flex-col md:flex-row justify-between pt-16 pb-40">
      ...
      <div class="mb-10 md:mb-0">
        ...
        <div class="flex flex-col gap-3">
          ...
          <a href="#" class="text-gray-300 hover:text-white">DPA</a>
          <a href="#" class="text-gray-300 hover:text-white">DMCA Policy</a>
          <a href="#" class="text-gray-300 hover:text-white">ERDF Support</a>
        </div>
      </div>
      <div>
        <h3 class="text-[#98A2B3]">Follow us</h3>
      </div>
    </div>
  </div>
</template>

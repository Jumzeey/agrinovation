...
<template>
  <div class="w-full md:w-[380px] h-full rounded-2xl bg-white shadow relative">
    <div class="p-6">
      <div class="w-full h-[220px]">
        <img
          :src="props.img"
          class="object-cover w-full h-[220px] rounded-2xl"
          alt=""
          v-if="props.img"
        />
      </div>
      ...
      <div class="relative">
        <div class="px-[11px] my-2 mt-[20px]">
          <h3 class="text-[#261B0D] text-xl font-semibold">
            {{ props.title }}
          </h3>

          <div>
            <p class="text-[#261B0D] text-md font-medium">{{ props.description }}</p>
          </div>
          
          <div class="flex gap-3 my-3" v-if="props.tags">
            <Badge class="success">

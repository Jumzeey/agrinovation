<template>
    <div>
        <h1 class="text-[#101828] text-xl font-semibold pb-1">Agro Investments</h1>
        <p class="text-[#667085] text-sm font-medium pb-4">
        Sorted by number of investment per sector
        </p>

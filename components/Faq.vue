  ...
  <div>
    ...
    <div id="accordion-collapse" data-accordion="collapse">
      <h2 id="accordion-collapse-heading-1">
        ...
        >
          <span>What is Agrinnovation about?</span>
          <svg
            data-accordion-icon
      ...
      <h2 id="accordion-collapse-heading-2">
        ...
        >
          <span class="text-[#101828]"
            >How can I register as an Agripreneur?</span
          >
          <svg
            data-accordion-icon
            class="w-3 h-3 rotate-180 shrink-0"
      ...
      <h2 id="accordion-collapse-heading-3">
        ...
        >
          <span class="text-[#101828]">What kind of data can I find here?</span>
          <svg
            data-accordion-icon
            class="w-3 h-3 rotate-180 shrink-0"
            aria-hidden="true"
      ...
      <h2 id="accordion-collapse-heading-4">
        ...
        >
          <span class="text-[#101828]">How does it benefit me?</span>
          <svg
            data-accordion-icon
            class="w-3 h-3 rotate-180 shrink-0"
            aria-hidden="true"
      ...
      <h2 id="accordion-collapse-heading-5">
        ...
        >
          <span class="text-[#101828]"
            >I have more questions who can I ask?</span
          >
          <svg
            data-accordion-icon
            class="w-3 h-3 rotate-180 shrink-0"
      ...
      <h2 id="accordion-collapse-heading-6">
        <button
          ...
          aria-controls="accordion-collapse-body-3"
        >
          <span class="text-[#101828]">How do I change my account email?</span>
          <svg
            data-accordion-icon
            class="w-3 h-3 rotate-180 shrink-0"
            aria-hidden="true"
